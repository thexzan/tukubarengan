...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Selanjutnya",sPrevious:"Sebelumnya"},sEmptyTable:"No data available in table",sInfo:"Menampilkan _START_ - _END_ dari total _TOTAL_ data",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(hasil filter dari _MAX_ total data)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Tampilkan _MENU_ baris",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Pencarian:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Tidak ada data yang cocok"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};X(m.defaults);m.defaults.column={aDataSort:null,
